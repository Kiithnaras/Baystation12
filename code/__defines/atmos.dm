...
#define TANK_LEAK_PRESSURE     (120 * ONE_ATMOSPHERE) // Tank starts leaking.
#define TANK_RUPTURE_PRESSURE  (150 * ONE_ATMOSPHERE) // Tank spills all contents into atmosphere.
#define TANK_FRAGMENT_PRESSURE (180 * ONE_ATMOSPHERE) // Boom 3x3 base explosion.

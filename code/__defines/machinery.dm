...
#define MAX_SCRUBBER_FLOWRATE 500  // L/s. Max flow rate when scrubbing from a turf.
...
#define ATMOS_PUMP_EFFICIENCY   4.0
#define ATMOS_FILTER_EFFICIENCY 4.0
...
#define ATMOS_DEFAULT_VOLUME_PUMP   250 // Liters.

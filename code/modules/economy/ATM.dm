				...
				if(authenticated_account.suspended)
					...
					switch(view_screen)
						...
						if(TRANSFER_FUNDS)
							...
							t += "<b>Account balance:</b> [authenticated_account.money] UEC"
		...
		switch(href_list["choice"])
			...
			if("balance_statement")
				if(authenticated_account)
					...
					R.info += "<i>Balance:</i> [authenticated_account.money] UEC<br>"

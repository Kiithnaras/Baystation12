...
/obj/item/weapon/spacecash/attackby(obj/item/weapon/W as obj, mob/user as mob)
	if(istype(W, /obj/item/weapon/spacecash))
		...
		to_chat(user, "<span class='notice'>You add [src.worth] UEC worth of money to the bundles.<br>It holds [bundle.worth] UEC now.</span>")
		qdel(src)
...
/obj/item/weapon/spacecash/bundle
	name = "pile of credit notes"
	icon_state = ""
	desc = "They are worth 0 UEC."
	worth = 0
...
/obj/item/weapon/spacecash/bundle/on_update_icon()
	...
	src.desc = "They are worth [worth] UEC."
	if(worth in denominations)
		src.SetName("[worth] UEC")
	else
		src.SetName("pile of [worth] UEC")
...
/obj/item/weapon/spacecash/bundle/attack_self()
	var/amount = input(usr, "How much UEC do you want to take? (0 to [src.worth])", "Take Money", 20) as num
...
/obj/item/weapon/spacecash/ewallet/examine(mob/user)
	...
	to_chat(user, "<span class='notice'>Charge card's owner: [src.owner_name]. UEC remaining: [src.worth].</span>")

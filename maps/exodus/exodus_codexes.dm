/datum/codex_entry/vox_employees
	display_name = "Vox Employees"
	lore_text = "<html><head><title>Working with the Vox: What you need to know</title></head><br><br>\
		<body>\
...
/datum/codex_entry/nanotrasen_sop
	display_name = "Nanotrasen Standard Operating Procedure"
	...
	lore_text = {"<html><head><title>Standard Operating Procedures</title></head><br><br>
	<body>
